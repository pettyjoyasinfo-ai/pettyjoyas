                  ...
                  <div key={i} className="flex flex-col gap-3 rounded-xl border border-line p-3 sm:flex-row">
                    ...
                    <div className="flex flex-1 flex-col gap-2">
                      ...
                      <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                        ...
                        <label className="flex flex-col gap-1">
                          <span className="text-[11px] text-muted">Grupo <span className="font-normal">· opcional</span></span>
                          <input value={v.group} onChange={(e) => setVariantField(i, "group", e.target.value)} placeholder="Femenino / Masculino" className={inp} />
                        </label>
                      </div>
                      ...
                      <div className="grid grid-cols-2 items-end gap-2 sm:grid-cols-[repeat(3,minmax(0,1fr))_auto]">
                        <label className="flex flex-col gap-1">
                          ...
                          <input value={v.price_delta} onChange={(e) => setVariantField(i, "price_delta", e.target.value)} placeholder="0" className={inp} />
                        </label>
                        <label className="flex flex-col gap-1">
                          <span className="text-[11px] text-muted">Peso (g) <span className="font-normal">· opcional</span></span>
                          <input value={v.weight} onChange={(e) => setVariantField(i, "weight", e.target.value)} placeholder="0" className={inp} />
                        </label>
                        <label className="flex flex-col gap-1">
                          <span className="text-[11px] text-muted">Stock</span>
                          <input value={v.stock} onChange={(e) => setVariantField(i, "stock", e.target.value)} placeholder="0" className={inp} />
                        </label>
